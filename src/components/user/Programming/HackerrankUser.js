import dogear from "./dog_Ear.jpg"

export default function HackerrankUser(props) {
...
<g>
  ...
  return (
    <div>
        ...
        {props.data.badges&&<div><p className='mt-2'>Badges earned : </p>
            <div style={{"display":"flex","justifyContent":"space-evenly","flexWrap":"wrap"}}>
            {props.data.badges.map(badge=>{
                return(
                    <div style={{height:"75px",width:"75px",display:"inline-block",margin:"0.8rem"}}>
        ...
        {props.data.certificates&&
            <div>
                <p className='mt-2'>Verified Skills : </p>
                <div style={{display:"flex",justifyContent:"space-around"}}>
                    {
                        props.data.certificates.map(cert=>{
                            return(
                                <a href={cert.cert_url} target="_blank" rel="noreferrer" style={{display:"inline-block",width:"100px",height:"133.325px",backgroundColor:"#1ba94c",color:"white",paddingLeft:"8px",marginRight:"5px"}}>
                                    <div style={{display:"flex",justifyContent:"space-around",padding:"0"}}>
                                        {verify_logo}
                                        <img src={dogear} height="35px"  />
                                    </div>
